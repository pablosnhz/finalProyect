...
private saveProgressToLocalStorageLectura() {
  localStorage.setItem('correctAnswersLectura', this.correctAnswersLectura.toString());
  localStorage.setItem('incorrectAnswersLectura', this.incorrectAnswersLectura.toString());
  localStorage.setItem('totalQuestionsLectura', this.totalQuestionsLectura.toString());
}

private loadProgressFromLocalStorageLectura() {
  this.correctAnswersLectura = parseInt(localStorage.getItem('correctAnswersLectura') || '0', 10);
  this.incorrectAnswersLectura = parseInt(localStorage.getItem('incorrectAnswersLectura') || '0', 10);
  this.totalQuestionsLectura = parseInt(localStorage.getItem('totalQuestionsLectura') || '0', 10);
}
...
private saveProgressToLocalStorageSociales() {
  localStorage.setItem('correctAnswersSociales', this.correctAnswersSociales.toString());
  localStorage.setItem('incorrectAnswersSociales', this.incorrectAnswersSociales.toString());
  localStorage.setItem('totalQuestionsSociales', this.totalQuestionsSociales.toString());
}

private loadProgressFromLocalStorageSociales() {
  this.correctAnswersSociales = parseInt(localStorage.getItem('correctAnswersSociales') || '0', 10);
  this.incorrectAnswersSociales = parseInt(localStorage.getItem('incorrectAnswersSociales') || '0', 10);
  this.totalQuestionsSociales = parseInt(localStorage.getItem('totalQuestionsSociales') || '0', 10);
}
...
private saveProgressToLocalStorageNaturales() {
  localStorage.setItem('correctAnswersNaturales', this.correctAnswersNaturales.toString());
  localStorage.setItem('incorrectAnswersNaturales', this.incorrectAnswersNaturales.toString());
  localStorage.setItem('totalQuestionsNaturales', this.totalQuestionsNaturales.toString());
}

private loadProgressFromLocalStorageNaturales() {
  this.correctAnswersNaturales = parseInt(localStorage.getItem('correctAnswersNaturales') || '0', 10);
  this.incorrectAnswersNaturales = parseInt(localStorage.getItem('incorrectAnswersNaturales') || '0', 10);
  this.totalQuestionsNaturales = parseInt(localStorage.getItem('totalQuestionsNaturales') || '0', 10);
}
...
private saveProgressToLocalStorageIngles() {
  localStorage.setItem('correctAnswersIngles', this.correctAnswersIngles.toString());
  localStorage.setItem('incorrectAnswersIngles', this.incorrectAnswersIngles.toString());
  localStorage.setItem('totalQuestionsIngles', this.totalQuestionsIngles.toString());
}

private loadProgressFromLocalStorageIngles() {
  this.correctAnswersIngles = parseInt(localStorage.getItem('correctAnswersIngles') || '0', 10);
  this.incorrectAnswersIngles = parseInt(localStorage.getItem('incorrectAnswersIngles') || '0', 10);
  this.totalQuestionsIngles = parseInt(localStorage.getItem('totalQuestionsIngles') || '0', 10);
}
